...
@section('content')
    <section class="flex hero lg:h-48 bg-brand-darker py-4 pt-32 bg-image-full" style="background-image: url('{{ $headerPhoto }}')">
        <div class="container mx-auto text-center md:text-left">
            <h1 class="text-white text-shadow" tabindex="0">Accessibility Policy</h1>
        </div>
    </section>
        ...
        <div class="container mx-auto py-2">
            <div class="flex flex-wrap items-center">
                <div class="flex-auto w-full md:w-3/4 px-3 py-2 text-center md:text-left" tabindex="0">
                    <p class="leading-normal text-grey-darker mb-3">I am committed to making my website content accessible to all users so it meets or exceeds the requirements of Section 508 of the Rehabilitation Act of 1973 as well as W3C’s Web Content Accessibility Guidelines (WCAG) 2.1 AA requirements.</p>
