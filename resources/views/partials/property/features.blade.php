<h2 class="mt-6 text-grey-darkest mx-1">Property Features</h2>
<table class="border-b-2 border-secondary-light mx-1 my-4 mb-1 shadow flex flex-col text-left text-grey-darkest">
