<div class="md:max-w-md mx-auto my-auto text-center flex flex-col items-center">
    ...
    <form class="quicksearch shadow-md md:rounded px-8 pt-6 pb-8 align-top h-auto" action="/property-search" method="GET">
        <fieldset class="w-100 flex flex-wrap ">
            <legend class="w-100 text-secondary bebas text-xl">Search for Real Estate</legend>
            {{ csrf_field() }}
            ...
            <div class="flex-auto px-2 py-2 xs:w-full w-full md:w-1/5">
                <button class="button-primary w-full h-10" type="submit" >Submit</button>
            </div>
        </fieldset>
    </form>
</div>