    ...
    <div class="w-full lg:max-w-lg mx-auto py-2 text-center">
        ...
        <div class="social-agent mt-2 px-4 text-center">
            @if ($realtor->data->fb_page_id)
                <a 
                    class="facebook" 
                    href="https://www.facebook.com/{{ $realtor->data->fb_page_id }}" 
                    target="_blank"
            ...
            <a 
                class="twitter" 
                href="https://twitter.com/{{ $realtor->data->twitter_handle }}" 
                target="_blank"
            ...
            <a 
                class="instagram" 
                href="https://instagram.com/{{ $realtor->data->instagram_handle }}" 
                target="_blank"
            ...
            <a 
                class="youtube" 
                href="https://www.youtube.com/channel/{{ $realtor->data->youtube_channel_id }}" 
                target="_blank"
