...
<body class="h-screen text-smoke-darkest">
    <div id="app" class="relative">
                ...
                <div class="flex items-center justify-center h-12">
                    ...
                    <div class="flex-1 text-right align-middle h-16">
                        ...
                        @else
                            ...
                            <a href="{{ route('logout') }}"
                                class="no-underline hover:underline text-dbblue-dark text-sm"
        ...
        <div class='bg-dbblue-lightest h-24'>
            @yield('navigation')
        </div>
        <div class='bg-dbblue-lightest'>
            @yield('content')
        </div>
    </div>
