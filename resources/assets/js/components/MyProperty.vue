<template>
  <div class="w-full md:w-1/2 lg:w-1/3 px-2 py-2">
    <div class="w-full flex bg-white py-2 text-primary">
      <p
        class="flex flex-wrap items-start text-center justify-center py-2 w-1/3 border-r"
      >
      ...
      <p
        class="flex flex-wrap items-center text-center justify-center py-2 w-1/3 border-r"
      >
    ...
    >
      ...
      <div class="property-details py-2 px-2">
        ...
        <div class="prop-type">
          <p
            class="pb-2 text-grey-darkest text-center text-xs text-grey-dark text-uppercase"
          >
