<template>
    <div
        class="container relative mx-auto flex flex-wrap py-4 px-8 bg-white mb-2 shadow border-l-4 border-grey-light"
        :class="{
    ...
    >
        <div class="w-full pr-8 text-grey-darkest">
            ...
            <p class="w-full flex flex-wrap block text-sm justify-start mb-2 md:mb-0">
                <a class="text-primary no-underline pr-4 mb-2" :href="`mailto:${lead.email}`">{{ lead.email }}</a>
                <a class="text-primary no-underline" :href="`tel:${lead.phone}`">{{ lead.phone }}</a>
            </p>
        </div>
        ...
        <div class="w-full flex flex-wrap text-grey-darker" v-if="lead.listing != null">
            ...
            <div class="w-full md:w-1/2 flex flex-wrap py-3 px-4">
                ...
                <a
                    ...
                    class="text-primary w-full md:w-1/3 block mb-4 pl-4"
                >
                    DIRECTIONS
                </a>
                <a
                    :href="'/listing/' + lead.listing"
                    class="text-primary w-auto block px-4"
                >
                    VIEW PROPERTY
                </a>
            </div>
            <div class="w-full md:w-1/2 flex flex-wrap py-3 px-4">
                ...
                <a href="#" class="text-primary w-full  no-underline md:w-1/2 block pr-4 mb-4 pl-4">Email: {{ lead.agent_email }}</a>
                <a href="#" class="text-primary no-underline w-auto block px-4">Phone: {{ lead.agent_phone }}</a>
            </div>
        </div>
        <div class="w-full xl:w-1/4 lg:w-1/3 xl:mt-2 lg:mt-1 py-4 lg:p-4 xl:p-4  xl:pin-r xl:pin-t lg:pin-r lg:pin-t flex justify-between relative lg:absolute xl:absolute items-center text-grey-darker">
            <a
                ...
                class="cursor-pointer text-center mr-4 w-16 h-16 hover:text-dark"
            ...
            <a
                class="cursor-pointer hover:text-dark text-center mr-4 w-16 h-16"
            ...
            <a
                class="cursor-pointer text-green hover:text-dark text-center mr-4 w-16 h-16"
